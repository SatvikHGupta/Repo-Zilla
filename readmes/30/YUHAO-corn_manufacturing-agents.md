# Manufacturing Intelligent Replenishment System
...
> **English** | A multi-agent LLM system for intelligent replenishment decisions in manufacturing supply chains. Six specialized AI agents (demand forecasting, cost analysis, supply chain coordination, market intelligence, decision-making, and risk management) collaborate through a LangGraph workflow to deliver data-driven restocking recommendations — reducing decision time from days to under 1 hour.
>
> **Tech Stack**: Python · LangChain · LangGraph · Streamlit · MongoDB · Redis
>
> **[中文文档见下方 ↓](#项目背景与价值)**
