...
**此项目是 [awesome-go](https://awesome-go.com/) 中文版，最后一次同步时间 : 2026-01-30 07:26:33(每隔1天同步一次)**
...
- [excelize](https://github.com/xuri/excelize) **star:20241** Golang图书馆阅读和写作微软Excel&trade;(XLSX)文件。   [![近一周有更新][G]](https://github.com/xuri/excelize)   [![godoc][D]](https://godoc.org/github.com/xuri/excelize)
...
- [gaio](https://github.com/xtaci/gaio) **star:1019** 高性能异步io网络在proactor模式下的Golang。   [![近一周有更新][G]](https://github.com/xtaci/gaio)   [![godoc][D]](https://godoc.org/github.com/xtaci/gaio)
...
- [tls-client](https://github.com/bogdanfinn/tls-client) **star:1425** net/http.Client like HTTP Client with options to select specific client TLS Fingerprints to use for requests.   [![近一周有更新][G]](https://github.com/bogdanfinn/tls-client)   [![godoc][D]](https://godoc.org/github.com/bogdanfinn/tls-client)
- [surf](https://github.com/enetx/surf) **star:1283** Advanced HTTP client with HTTP/1.1, HTTP/2, HTTP/3 (QUIC), SOCKS5 proxy support and browser-grade TLS fingerprinting.   [![近一周有更新][G]](https://github.com/enetx/surf)   [![godoc][D]](https://godoc.org/github.com/enetx/surf)
...
- [GORM](https://github.com/go-gorm/gorm) **star:39444** 一个出色的 ORM 库。主要目标是对开发人员友好。   [![godoc][D]](https://godoc.org/github.com/go-gorm/gorm)
- [ent](https://github.com/facebook/ent) **star:16882** 一个用于Go的实体框架。用于建模和查询数据的简单而强大的ORM。   [![godoc][D]](https://godoc.org/github.com/facebook/ent)
...
- [bob](https://github.com/stephenafamo/bob) **star:1611** SQL query builder and ORM/Factory generator for Go. Successor of SQLBoiler.   [![近一周有更新][G]](https://github.com/stephenafamo/bob)   [![godoc][D]](https://godoc.org/github.com/stephenafamo/bob)
...
- [syft](https://github.com/anchore/syft) **star:8295** A CLI tool and Go library for generating a Software Bill of Materials (SBOM) from container images and filesystems.   [![近一周有更新][G]](https://github.com/anchore/syft)   [![godoc][D]](https://godoc.org/github.com/anchore/syft)
...
- [jaeger](https://github.com/jaegertracing/jaeger) **star:22401** 分布式跟踪系统。   [![近一周有更新][G]](https://github.com/jaegertracing/jaeger)   [![godoc][D]](https://godoc.org/github.com/jaegertracing/jaeger)
- [ebpf-go](https://github.com/cilium/ebpf) **star:7496** Provides utilities for loading, compiling, and debugging eBPF programs.   [![近一周有更新][G]](https://github.com/cilium/ebpf)   [![godoc][D]](https://godoc.org/github.com/cilium/ebpf)
...
- [dasel](https://github.com/tomwright/dasel) **star:7804** 使用命令行中的选择器查询和更新数据结构。与jq/yq类似，但支持JSON、YAML、TOML和XML，运行时依赖关系为零。   [![近一周有更新][G]](https://github.com/tomwright/dasel)   [![godoc][D]](https://godoc.org/github.com/tomwright/dasel)
...
- [age](https://github.com/FiloSottile/age) **star:21103** 一个简单、现代和安全的加密工具(和Go库)，具有小的显式密钥，没有配置选项，并且具有unix风格的可组合性。   [![godoc][D]](https://godoc.org/github.com/FiloSottile/age)
- [lego](https://github.com/go-acme/lego) **star:9208** 纯 Go ACME 客户端库及命令行工具   [![近一周有更新][G]](https://github.com/go-acme/lego)   [![godoc][D]](https://godoc.org/github.com/go-acme/lego)
...
- [Cameradar](https://github.com/Ullaakut/cameradar) **star:4840** 工具和库，以远程入侵RTSP流从监控摄像头。   [![近一周有更新][G]](https://github.com/Ullaakut/cameradar)   [![godoc][D]](https://godoc.org/github.com/Ullaakut/cameradar)
- [Coraza](https://github.com/corazawaf/coraza) **star:3227** 企业级、modsecurity和OWASP CRS兼容WAF库。   [![近一周有更新][G]](https://github.com/corazawaf/coraza)   [![godoc][D]](https://godoc.org/github.com/corazawaf/coraza)
...
- [beelzebub](https://github.com/mariocandela/beelzebub) **star:1823** A secure low code honeypot framework, leveraging AI for System Virtualization.   [![近一周有更新][G]](https://github.com/mariocandela/beelzebub)   [![godoc][D]](https://godoc.org/github.com/mariocandela/beelzebub)
...
- [Caddy](https://github.com/caddyserver/caddy) **star:69495** Caddy是另一种HTTP/2 web服务器，易于配置和使用。   [![godoc][D]](https://godoc.org/github.com/caddyserver/caddy)
- [consul](https://www.consul.io/)  Consul 是一个用于服务发现、监控和配置的工具
- [minio](https://github.com/minio/minio) **star:59981** Minio是一个分布式对象存储服务器。   [![godoc][D]](https://godoc.org/github.com/minio/minio)
- [pocketbase](https://github.com/pocketbase/pocketbase) **star:55662** PocketBase is a realtime backend in 1 file consisting of embedded database (SQLite) with realtime subscriptions, built-in auth management and much more.   [![近一周有更新][G]](https://github.com/pocketbase/pocketbase)   [![godoc][D]](https://godoc.org/github.com/pocketbase/pocketbase)
- [etcd](https://github.com/etcd-io/etcd) **star:51417** 为共享配置和服务发现提供高可用的键值存储。   [![近一周有更新][G]](https://github.com/etcd-io/etcd)   [![godoc][D]](https://godoc.org/github.com/etcd-io/etcd)
- [SFTPGo](https://github.com/drakkan/sftpgo) **star:11631** 完全功能和高度可配置的SFTP服务器与可选的FTP/S和WebDAV支持。它可以为本地文件系统和云存储后端(如S3和谷歌云存储)提供服务。   [![近一周有更新][G]](https://github.com/drakkan/sftpgo)   [![godoc][D]](https://godoc.org/github.com/drakkan/sftpgo)
- [RoadRunner](https://github.com/spiral/roadrunner) **star:8384** 高性能PHP应用服务器，负载平衡器和进程管理器。   [![近一周有更新][G]](https://github.com/spiral/roadrunner)   [![godoc][D]](https://godoc.org/github.com/spiral/roadrunner)
...
- [Wish](https://github.com/charmbracelet/wish) **star:4829** 制作SSH应用程序，就像这样!   [![godoc][D]](https://godoc.org/github.com/charmbracelet/wish)
...
- [Fider](https://github.com/getfider/fider) **star:4057** Fider是一个收集和组织客户反馈的开放平台。   [![近一周有更新][G]](https://github.com/getfider/fider)   [![godoc][D]](https://godoc.org/github.com/getfider/fider)
- [devd](https://github.com/cortesi/devd) **star:3471** 为开发人员提供本地web服务器。   [![godoc][D]](https://godoc.org/github.com/cortesi/devd)
- [algernon](https://github.com/xyproto/algernon) **star:2979** 内置支持Lua、Markdown、GCSS和Amber的HTTP/2 web服务器。   [![近一周有更新][G]](https://github.com/xyproto/algernon)   [![godoc][D]](https://godoc.org/github.com/xyproto/algernon)
...
- [go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) **star:1915** A simple, complete and lightweight self-hosted feature flag solution 100% Open Source.   [![近一周有更新][G]](https://github.com/thomaspoignant/go-feature-flag)   [![godoc][D]](https://godoc.org/github.com/thomaspoignant/go-feature-flag)
...
- [ro](https://github.com/samber/ro) **star:572** Reactive Programming: declarative and composable API for event-driven applications.   [![近一周有更新][G]](https://github.com/samber/ro)   [![godoc][D]](https://godoc.org/github.com/samber/ro)
...
- [templ](https://github.com/a-h/templ) **star:10025** A HTML templating language that has great developer tooling.   [![godoc][D]](https://godoc.org/github.com/a-h/templ)
...
- [Testify](https://github.com/stretchr/testify) **star:25730** 对标准测试包的扩展。   [![godoc][D]](https://godoc.org/github.com/stretchr/testify)
- [keploy](https://github.com/keploy/keploy) **star:15586** Generate Testcase and Data Mocks from API calls automatically.   [![近一周有更新][G]](https://github.com/keploy/keploy)   [![godoc][D]](https://godoc.org/github.com/keploy/keploy)
- [testcontainers-go](https://github.com/testcontainers/testcontainers-go) **star:4627** A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done.   [![近一周有更新][G]](https://github.com/testcontainers/testcontainers-go)   [![godoc][D]](https://godoc.org/github.com/testcontainers/testcontainers-go)
- [go-cmp](https://github.com/google/go-cmp) **star:4583** 用于比较测试中的Go值的包。   [![godoc][D]](https://godoc.org/github.com/google/go-cmp)
...
- [go-httpbin](https://github.com/mccutchen/go-httpbin) **star:806** HTTP testing and debugging tool with various endpoints for client testing.   [![近一周有更新][G]](https://github.com/mccutchen/go-httpbin)   [![godoc][D]](https://godoc.org/github.com/mccutchen/go-httpbin)
...
- [mockery](https://github.com/vektra/mockery) **star:6967** 生成Go界面的工具。   [![近一周有更新][G]](https://github.com/vektra/mockery)   [![godoc][D]](https://godoc.org/github.com/vektra/mockery)
...
- [chromedp](https://github.com/knq/chromedp) **star:12692** 用于驱动和测试 Chrome, Safari, Edge, Android Webviews, 以及其他支持 Chrome 调试协议的产品   [![godoc][D]](https://godoc.org/github.com/knq/chromedp)
- [rod](https://github.com/go-rod/rod) **star:6596** 一个Devtools驱动程序，使web自动化和抓取更加容易。   [![godoc][D]](https://godoc.org/github.com/go-rod/rod)
- [playwright-go](https://github.com/mxschmitt/playwright-go) **star:3144** 浏览器自动化库控制铬，Firefox和WebKit与一个单一的API。   [![godoc][D]](https://godoc.org/github.com/mxschmitt/playwright-go)
...
- [goldmark](https://github.com/yuin/goldmark) **star:4567** A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured.   [![godoc][D]](https://godoc.org/github.com/yuin/goldmark)
- [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) **star:3374** 将HTML转换成Markdown   [![近一周有更新][G]](https://github.com/JohannesKaufmann/html-to-markdown)   [![godoc][D]](https://godoc.org/github.com/JohannesKaufmann/html-to-markdown)
...
- [godump (goforj)](https://github.com/goforj/godump) **star:1676** Pretty-print Go structs with Laravel/Symfony-style dumps, full type info, colorized CLI output, cycle detection, and private field access.   [![godoc][D]](https://godoc.org/github.com/goforj/godump)
...
- [bluemonday](https://github.com/microcosm-cc/bluemonday) **star:3614** HTML 清理工具   [![godoc][D]](https://godoc.org/github.com/microcosm-cc/bluemonday)
...
- [colly](https://github.com/asciimoo/colly) **star:25035** 快速和优雅的 Scraping 框架。   [![godoc][D]](https://godoc.org/github.com/asciimoo/colly)
...
- [lancet](https://github.com/duke-git/lancet) **star:5266** A comprehensive, Lodash-like utility library for Go   [![近一周有更新][G]](https://github.com/duke-git/lancet)   [![godoc][D]](https://godoc.org/github.com/duke-git/lancet)   [![包含中文文档][CN]](https://github.com/duke-git/lancet)
...
- [github](https://github.com/google/go-github) **star:11109** 访问GitHub REST API v3的库。   [![近一周有更新][G]](https://github.com/google/go-github)   [![godoc][D]](https://godoc.org/github.com/google/go-github)
...
- [google](https://github.com/google/google-api-go-client) **star:4388** 为Go自动生成谷歌api。   [![近一周有更新][G]](https://github.com/google/google-api-go-client)   [![godoc][D]](https://godoc.org/github.com/google/google-api-go-client)
...
- [fzf](https://github.com/junegunn/fzf) **star:77369** 用Go编写的命令行模糊查找器。   [![近一周有更新][G]](https://github.com/junegunn/fzf)   [![godoc][D]](https://godoc.org/github.com/junegunn/fzf)
- [dive](https://github.com/wagoodman/dive) **star:53225** A tool for exploring each layer in a Docker image.   [![godoc][D]](https://godoc.org/github.com/wagoodman/dive)
...
- [lo](https://github.com/samber/lo) **star:20887** 一个基于Go 1.18的Lodash类库+泛型(map, filter, contains, find…)   [![近一周有更新][G]](https://github.com/samber/lo)   [![godoc][D]](https://godoc.org/github.com/samber/lo)
- [ctop](https://github.com/bcicen/ctop) **star:17553** [Top-like](https://ctop.sh)接口(例如htop)用于容器度量。   [![godoc][D]](https://godoc.org/github.com/bcicen/ctop)
- [sqlx](https://github.com/jmoiron/sqlx) **star:17481** 为内建的数据库/sql 软件包提供一组扩展。   [![godoc][D]](https://godoc.org/github.com/jmoiron/sqlx)
- [goreleaser](https://github.com/goreleaser/goreleaser) **star:15522** 尽可能快速的发布 Go 语言二进制文件。   [![近一周有更新][G]](https://github.com/goreleaser/goreleaser)   [![godoc][D]](https://godoc.org/github.com/goreleaser/goreleaser)
- [wuzz](https://github.com/asciimoo/wuzz) **star:10713** 用于HTTP检查的交互式cli工具。   [![godoc][D]](https://godoc.org/github.com/asciimoo/wuzz)
- [usql](https://github.com/knq/usql) **star:9789** usql 是一个通用的命令行接口，用于操作 sql 数据库。   [![godoc][D]](https://godoc.org/github.com/knq/usql)
...
- [mc](https://github.com/minio/mc) **star:3359** Minio Client 提供了一组工具，用于操作 Amazon S3 兼容云存储和文件系统。   [![godoc][D]](https://godoc.org/github.com/minio/mc)
...
- [sesh](https://github.com/joshmedeski/sesh) **star:1618** Sesh is a CLI that helps you create and manage tmux sessions quickly and easily using zoxide.   [![godoc][D]](https://godoc.org/github.com/joshmedeski/sesh)
...
- [json-log-viewer](https://github.com/hedhyw/json-log-viewer) **star:208** Interactive viewer for JSON logs.   [![godoc][D]](https://godoc.org/github.com/hedhyw/json-log-viewer)
...
- [uuid](https://github.com/google/uuid) **star:5977** 基于RFC 4122和DCE 1.1的uuid包:身份验证和安全服务。   [![godoc][D]](https://godoc.org/github.com/google/uuid)
...
- [validator](https://github.com/go-playground/validator) **star:19634**  Go 结构体及域验证，包括：跨域、跨结构体, Map, 切片和数组。   [![godoc][D]](https://godoc.org/github.com/go-playground/validator)
...
- [gortsplib](https://github.com/aler9/gortsplib) **star:882** 纯Go RTSP服务器和客户端库。   [![近一周有更新][G]](https://github.com/aler9/gortsplib)   [![godoc][D]](https://godoc.org/github.com/aler9/gortsplib)
...
- [Gin](https://github.com/gin-gonic/gin) **star:87837** Gin是一个用Go编写的web框架!它具有一个类似于martini的API，性能更好，速度快40倍。   [![近一周有更新][G]](https://github.com/gin-gonic/gin)   [![godoc][D]](https://godoc.org/github.com/gin-gonic/gin)
- [Fiber](https://github.com/gofiber/fiber) **star:39055** 一个灵感来自Express.js的web框架构建在Fasthttp上。   [![近一周有更新][G]](https://github.com/gofiber/fiber)   [![godoc][D]](https://godoc.org/github.com/gofiber/fiber)
...
- [Echo](https://github.com/labstack/echo) **star:32106** 高性能、极简的Go web框架。   [![近一周有更新][G]](https://github.com/labstack/echo)   [![godoc][D]](https://godoc.org/github.com/labstack/echo)
- [GoFr](https://github.com/gofr-dev/gofr) **star:15735** Gofr is an opinionated microservice development framework.   [![近一周有更新][G]](https://github.com/gofr-dev/gofr)   [![godoc][D]](https://godoc.org/github.com/gofr-dev/gofr)
...
- [alice](https://github.com/justinas/