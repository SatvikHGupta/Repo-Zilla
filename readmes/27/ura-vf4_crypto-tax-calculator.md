...
1. Windows and Linux configurations are described below. macOS users can utilize the [DMG file](../../releases).





Prerequisites: Ensure Git and Python are installed.
...
```bash 
git clone https://github.com/ura-vf4/crypto-tax-calculator.git
```
```bash 
