...
📌 升级基线与分批迁移计划请参考：[`docs/version-baseline.md`](docs/version-baseline.md)。
...
- [x] sso-oauth2-demo: [Spring Boot OAuth2 单点登录示例](https://mp.weixin.qq.com/s/2davYzHuGKRQD1m-Atjs3w)（含旧栈，迁移说明见 `13-sso-oauth2-demo/README.md`）
