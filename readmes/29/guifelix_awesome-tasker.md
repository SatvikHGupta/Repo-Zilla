...
- [ContactsTask](https://apkpure.com/contactstask/com.balda.contactstask) - Read contacts from device.
- [AirTask](https://apkpure.com/airtask/com.balda.airtask) - Allows to send messages or files from one device to another using wifi or bluetooth.
- [DriveTask](https://apkpure.com/drivetask/com.balda.drivetask) - Allows to perform operations on Google Drive™.
- [CalendarTask](https://apkpure.com/calendartask/com.balda.calendartask) - Allows to interact with calendar.
...
- [UiTask](https://apkpure.com/uitask/com.balda.uitask) - Show simple dialogs and pickers using material design.
- [CastTask](https://apkpure.com/casttask/com.balda.casttask) - Allows you to cast multimedia content using Tasker.
- [ParseTask](https://play.google.com/store/apps/details?id=com.balda.parsetask) - Read data in JSON, XML and HTML.
- [NFC for Tasker](https://apkpure.com/nfc-for-tasker/com.balda.nfcfortasker) - Read and write on NFC tags using Tasker.
...
- [IntentTask](https://apkpure.com/intenttask/com.balda.intenttask) - Allows Tasker to send Android™ intents.
- [MeteoTask](https://play.google.com/store/apps/details?id=com.balda.meteotask) - Get weather information on Tasker.
- [ActivityTask](https://apkpure.com/activitytask/com.balda.autoactivity) - Detect when you are in a vehicle, on foot, on bike, still or if the phone is tilting.
- [ClockTask](https://apkpure.com/clocktask/com.balda.clocktask) - Interact with Android™ clock app.
- [BlueTask](https://apkpure.com/bluetask/com.balda.bluetask) - Allows audio routing using bluetooth headset.
- [GeoTask](https://apkpure.com/geotask/com.balda.geotask) - Create geographic areas to be monitored.
- [Auto Speed Trap](https://apkpure.com/auto-speed-trap/com.balda.autospeedtrap) - Automate the start and stop of [Speed Trap](https://apkpure.com/speed-trap/com.balda.speedtrap).
- [Tasker Now](https://apkpure.com/tasker-now/com.balda.taskernow) - Use Google Assistant as input for Tasker from your phone or smartwatch.
### Others Vendors
- [Tasker Network Event Server](https://apkpure.com/tasker-network-event-server/bidoismorgan.httpevent) - Enables Tasker to trigger events when receiving messages over network.
...
- [Notifications Off](https://apkpure.com/notifications-off-root/com.aboutmycode.NotificationsOff) - Enables Tasker to manage app notifications in a centralized way.
...
- [SharpTools Tasker Plugin & Widgets for SmartThings](https://apkpure.com/sharptools-tasker-plugin-widgets-for-smartthings/com.boshdirect.stwidgets) - [SharpTools](https://sharptools.io/) is a set of Widgets and Tasker plugins for the SmartThings™ platform.
- [Jewish Tasker Plugin](https://apkpure.com/jewish-tasker-plugin/com.chaimchaikin.jewishdatetasker) - Tasker plugin to get the Jewish/Hebrew Date and Zmanim.
- [RepetiTouch Pro](https://apkpure.com/repetitouch-pro-root/com.cygery.repetitouch.pro) - RepetiTouch enables easy recording and replaying of touch events.
...
## Mentioned In
- [Starkville Tech Meetup](https://github.com/starkville-tech-meetup/starkville-tech-meetup.github.io/blob/0e9cc0fd7b86ac02aed88f314d5bdfa5ef844186/docs/presentations/quarto/automating-where-you-least-expect/presentation.qmd#L252)
- [More Awesome](https://github.com/0ex/more-awesome/blob/162c68241bca9458475974555591abf55e1d2439/README.md?plain=1#L1119)
- [MattASmithWork/learningCoding](https://github.com/MattASmithWork/learningCoding/blob/99c9f5dd9dcb8f0721af1950fc728c4016596149/resource_tracking/android.xml#L7)
- [TechPP](https://techpp.com/2026/01/06/best-android-shortcut-apps/#:~:text=However%2C%20there%20are-,tens%20of%20websites,-and%C2%A0utilities%20that)

## Repo Meta Info

### Stats

<a href="https://www.star-history.com/?repos=guifelix%2Fawesome-tasker&type=date&legend=top-left">
 <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=guifelix/awesome-tasker&style=landscape1&theme=dark" />
    <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=guifelix/awesome-tasker&style=landscape1" />
    <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=guifelix/awesome-tasker&style=landscape1" />
 </picture>
</a>
...
<a href="https://www.star-history.com/?repos=guifelix%2Fawesome-tasker&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=guifelix/awesome-tasker&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=guifelix/awesome-tasker&type=date&legend=top-left" />
   <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=guifelix/awesome-tasker&type=date&legend=top-left" />
 </picture>
</a>
